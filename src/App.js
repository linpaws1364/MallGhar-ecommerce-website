...
const App = () => {
  ...
  // function to control click event to add items in cart 
  ...
  // function to keep track of amount change in cart 
  ...
  return (
    <>
      <Router>
        <Navbar />
        {/* div for the container with all items and sort button */}
